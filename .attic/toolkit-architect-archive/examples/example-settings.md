...
- [Template: Basic Configuration](#template-basic-configuration)
- [Template: Advanced Configuration](#template-advanced-configuration)
- [Additional Notes](#additional-notes)
- [Template: Agent State File](#template-agent-state-file)
- [Requirements](#requirements)
- [Success Criteria](#success-criteria)
- [Coordination](#coordination)
- [Template: Feature Flag Pattern](#template-feature-flag-pattern)
- [Usage in Hooks](#usage-in-hooks)
- [Gitignore](#gitignore)
