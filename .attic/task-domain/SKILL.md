...
**Purpose**: Coordinate complex workflows and provide TaskList orchestration guidance with quality validation
...
This skill is self-contained and does not depend on other skills for execution. It includes all necessary knowledge for TaskList orchestration, context spanning, and multi-session coordination.

**May be called by**:
- User requests for complex workflow orchestration
- Other skills seeking TaskList guidance
...
**Use this skill when**:
- "Multi-session project" or "Context window spanning"
- "Project persistence" or "Complex multi-step workflow"
- "Indefinitely long project" or "Task management guidance"
- Work exceeds Claude's autonomous execution
...
Apply quality framework during task orchestration work:

**Validate TaskList configuration**:
- Appropriate use of TaskList (complex workflows only)
- Proper dependency tracking
- Clear task definitions and owners
- Effective multi-session coordination

**Check for anti-patterns**:
- Using TaskList for simple workflows
- Tasks without dependencies
- Missing task ownership
- No persistence when needed
