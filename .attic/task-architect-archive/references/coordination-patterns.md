...
Delegates to:
- **skills-architect** - Domain expertise routing
- **subagents-architect** - Isolation/parallelism routing
- **meta-architect-claudecode** - Layer selection guidance
- **toolkit-quality-validator** - Quality compliance

Routes from:
- **toolkit-architect** - Main project scaffolding router
