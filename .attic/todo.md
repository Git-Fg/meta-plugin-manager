---
description: "Maintain TODO.md with real-time progress tracking when user mentions 'todo', 'task list', or 'track progress'. Not for simple reminders or single-task workflows."
argument-hint: "[action] [task description]"
allowed-tools: ["Read", "Write", "TodoWrite"]
---

<mission_control>
<objective>Maintain TODO.md with real-time progress tracking for multi-task workflows</objective>
<success_criteria>TODO.md updated with task states, progress calculated, discovered tasks added</success_criteria>
</mission_control>

<interaction_schema>
initialize → in_progress → update → recalculate → discover → repeat
</interaction_schema>
...
<critical_constraint>
MANDATORY: Update TODO.md on every state change
MANDATORY: Mark exactly one task as in_progress
MANDATORY: Add discovered tasks immediately when found
No exceptions. TODO.md must be a living document, not stale.
