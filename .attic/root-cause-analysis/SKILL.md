...
description: "Drill down to root causes using the '5 Whys' technique to understand the fundamental issue behind a symptom or prevent recurrence. Not for simple bugs with obvious causes or non-recurrable issues."
---
...
<critical_constraint>
MANDATORY: Verify each "why" answer with factual evidence
MANDATORY: Focus on systems/processes, not blame on individuals
MANDATORY: Continue until reaching an actionable root cause
MANDATORY: Derive actionable action items to prevent recurrence
MANDATORY: Stop when you reach something you can actually fix
No exceptions. Root cause analysis without action is wasted effort.
</critical_constraint>
