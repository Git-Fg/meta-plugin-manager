...
keywords: deviation, autonomous, rules, execution, bug-fix, blockers
---
...
## PATTERN: The Path to High-Autonomy Success
...
| If you need...           | Read...                                |
| :----------------------- | :------------------------------------- |
| Bug fix                  | ## PATTERN: Workflow → Rule 1: Bug              |
| Missing critical feature | ## PATTERN: Workflow → Rule 2: Missing Critical |
| Blocker resolution       | ## PATTERN: Workflow → Rule 3: Blocker          |
| Architecture change      | ## PATTERN: Workflow → Rule 4: Architecture     |
| Enhancement logging      | ## PATTERN: Workflow → Rule 5: Enhancement      |
| Deviation classification | ## PATTERN: Decision Flow              |
...
| Trigger conditions verified? | Rule's test conditions checked |
| Bug has unambiguous fix? | Logic error with clear solution |
| Missing critical clearly overlooked? | Essential for functionality, not new feature |
| Architectural affects structure? | File/folder changes, multiple valid approaches |
| Enhancement valuable but not essential? | Can be deferred without impact |
| Documentation complete? | Every deviation in SUMMARY.md |
