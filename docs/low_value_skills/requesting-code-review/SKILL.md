...
keywords: code-review, pre-review, two-stage, checklist, feedback
---

## Quick Start

**Pre-review:** Run tests, lint, type-check, self-review

**Stage 1:** Spec compliance check (requirements met)

**Stage 2:** Quality review (patterns, consistency)

## Navigation

| If you need... | Read this section... |
| :------------- | :------------------- |
| Pre-review checklist | ## PATTERN: Pre-Review Checklist |
| Two-stage process | ## PATTERN: Two-Stage Review |
| Examples | ## EDGE: Worked Examples |
| Common mistakes | ## ANTI-PATTERN: Common Mistakes |
| Self-check | ## Recognition Questions |

## PATTERN: The Path to High-Quality Review Success
...
| :------------------- | :--------------------------------- |
| Pre-review checklist | ## PATTERN: Pre-Review Checklist |
| Stage 1 review       | ## PATTERN: Two-Stage Review → Stage 1 |
| Stage 2 review       | ## PATTERN: Two-Stage Review → Stage 2 |
| Format request       | ## PATTERN: Request Format        |
| Review process flow  | ## PATTERN: Review Process Flow   |
| Submit review        | Use `/review` command              |

## PATTERN: Review Process Flow
...
## PATTERN: Two-Stage Review Process
