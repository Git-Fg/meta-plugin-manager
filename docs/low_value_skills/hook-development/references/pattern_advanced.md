---
description: "Advanced hook patterns for complex automation. Use when implementing multi-stage validation, conditional execution, or performance optimization. Includes sequential hooks, conditionals, and resource management."
---
