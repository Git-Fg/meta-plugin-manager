---
description: "Reference examples for agent trigger conditions. Use when crafting agent descriptions with effective activation patterns. Includes explicit, proactive, and implicit trigger examples with context patterns."
---
