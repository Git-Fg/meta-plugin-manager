...
exports.sequentialQueue = exports.SequentialQueue = void 0;
...
exports.SequentialQueue = SequentialQueue;
exports.sequentialQueue = new SequentialQueue();
async function runSequential(agentId, fn) {
    return exports.sequentialQueue.runSequential(agentId, fn);
}
