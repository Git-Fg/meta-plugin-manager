...
export declare function log_llm_request(agentId: string, providerName: string, model: string, requestData: unknown, timestamp?: Date, requestId?: string, tags?: string[]): string;
