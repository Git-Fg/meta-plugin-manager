...
exports.DeltaBuffer = void 0;
exports.bufferDelta = bufferDelta;
exports.flushBufferedDeltas = flushBufferedDeltas;
class DeltaBuffer {
    step;
    max;
    timeLimitMs;
...
exports.DeltaBuffer = DeltaBuffer;
function bufferDelta(store, messageId, chunk, makeEvent) {
...
function flushBufferedDeltas(store, makeEvent) {
    const events = [];
