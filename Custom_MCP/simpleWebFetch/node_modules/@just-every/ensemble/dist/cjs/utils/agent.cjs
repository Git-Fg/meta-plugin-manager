...
exports.Agent = exports.exportAgent = exports.agentToolCache = void 0;
exports.getAgentSpecificTools = getAgentSpecificTools;
exports.cloneAgent = cloneAgent;
exports.getToolsFromAgent = getToolsFromAgent;
const create_tool_function_js_1 = require("./create_tool_function.cjs");
const ensemble_request_js_1 = require("../core/ensemble_request.cjs");
const uuid_1 = require("uuid");
exports.agentToolCache = new Map();
var agent_export_js_1 = require("./agent_export.cjs");
Object.defineProperty(exports, "exportAgent", { enumerable: true, get: function () { return agent_export_js_1.exportAgent; } });
function getAgentSpecificTools(agent_id) {
    const tools = [];
    if (exports.agentToolCache.has(agent_id)) {
        tools.push(...exports.agentToolCache.get(agent_id));
    }
    return tools;
}
...
class Agent {
    ...
    asTool() {
        ...
        return (0, create_tool_function_js_1.createToolFunction)(async (...args) => {
            const agent = cloneAgent(this);
            agent.agent_id = (0, uuid_1.v4)();
...
async function runAgentTool(agent, prompt, intelligence) {
    ...
    try {
        ...
        const stream = (0, ensemble_request_js_1.ensembleRequest)(messages, agent);
        let fullResponse = '';
...
async function getToolsFromAgent(agent) {
