...
exports.truncateLargeValues = void 0;
...
const truncateLargeValues = (obj, maxLength = 1000) => {
    ...
    if (Array.isArray(obj)) {
        return obj.map(item => (0, exports.truncateLargeValues)(item, maxLength));
    }
    if (obj && typeof obj === 'object') {
        const result = {};
        for (const [key, value] of Object.entries(obj)) {
            result[key] = (0, exports.truncateLargeValues)(value, maxLength);
        }
        return result;
    }
    return obj;
};
exports.truncateLargeValues = truncateLargeValues;
