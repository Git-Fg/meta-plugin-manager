...
exports.ElevenLabsProvider = exports.elevenLabsProvider = exports.ELEVENLABS_VOICES = void 0;
...
class ElevenLabsProvider extends base_provider_js_1.BaseModelProvider {
    _apiKey;
    ...
    async createVoice(text, model, agent, opts) {
        ...
        try {
            ...
            if (voiceId in exports.ELEVENLABS_VOICES) {
                voiceId = exports.ELEVENLABS_VOICES[voiceId];
            }
            ...
            const loggedRequestId = (0, llm_logger_js_1.log_llm_request)(agent.agent_id || 'default', 'elevenlabs', modelId, requestBody, new Date(), requestId, agent.tags);
...
exports.elevenLabsProvider = new ElevenLabsProvider();
