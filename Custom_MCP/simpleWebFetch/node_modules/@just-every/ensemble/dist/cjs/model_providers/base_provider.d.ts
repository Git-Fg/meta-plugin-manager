...
export declare abstract class BaseModelProvider implements ModelProvider {
    ...
    abstract createResponseStream(messages: ResponseInput, model: string, agent: AgentDefinition, requestId?: string): AsyncGenerator<ProviderStreamEvent>;
    createResponseStreamWithRetry(messages: ResponseInput, model: string, agent: AgentDefinition, requestId?: string): AsyncGenerator<ProviderStreamEvent>;
