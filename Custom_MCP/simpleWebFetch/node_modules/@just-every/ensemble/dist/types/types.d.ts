...
export type ResponseContent = string | Array<ResponseContentText | ResponseContentImage | ResponseContentImageData | ResponseContentFileInput>;
...
export type StreamEventType = 'connected' | 'command_start' | 'command_done' | 'project_create' | 'project_update' | 'process_start' | 'process_running' | 'process_updated' | 'process_done' | 'process_failed' | 'process_waiting' | 'process_terminated' | 'message_start' | 'message_delta' | 'message_complete' | 'audio_stream' | 'tool_start' | 'tool_delta' | 'tool_done' | 'file_start' | 'file_delta' | 'file_complete' | 'image_start' | 'image_complete' | 'cost_update' | 'system_status' | 'system_update' | 'quota_update' | 'screenshot' | 'design_grid' | 'console' | 'error' | 'response_output' | 'tool_wait_start' | 'tool_waiting' | 'tool_wait_complete' | 'task_wait_start' | 'task_waiting' | 'task_wait_complete' | 'task_start' | 'task_complete' | 'task_fatal_error' | 'git_pull_request' | 'stream_end' | 'agent_start' | 'agent_status' | 'agent_done';
...
export type ModelClassID = 'standard' | 'mini' | 'reasoning' | 'reasoning_high' | 'reasoning_mini' | 'monologue' | 'metacognition' | 'code' | 'writing' | 'summary' | 'vision' | 'vision_mini' | 'long' | 'image_generation' | 'embedding' | 'voice' | 'transcription';
export type ModelProviderID = 'openai' | 'anthropic' | 'google' | 'xai' | 'deepseek' | 'openrouter' | 'elevenlabs' | 'luma' | 'ideogram' | 'midjourney' | 'stability' | 'fireworks' | 'fal' | 'runway' | 'bytedance' | 'test';
...
export interface EnsembleLogger {
    log_llm_request(agentId: string, providerName: string, model: string, requestData: unknown, timestamp?: Date, requestId?: string, tags?: string[]): string;
...
export interface ImageGenerationOpts {
    n?: number;
    size?: 'square' | 'landscape' | 'portrait' | '1024x1024' | '1536x1024' | '1024x1536' | '1792x1024' | '1024x1792' | '1696x2528' | '2048x2048' | '512x512' | '256x256';
    quality?: 'standard' | 'hd' | 'low' | 'medium' | 'high';
    style?: 'vivid' | 'natural';
    response_format?: 'url' | 'b64_json';
    source_images?: string | string[] | Array<{
        data: string;
        metadata?: {
            category?: string;
            title?: string;
