...
<success_criteria>
Domain expertise enables accurate planning with context-efficient reference loading. Plans generated with this expertise should:

- Use appropriate domain patterns (architecture, conventions, workflows)
- Reference correct framework APIs and libraries
- Follow platform-specific best practices
- Avoid common domain-specific pitfalls
  </success_criteria>
...
<critical_constraint>
MANDATORY: Domain expertise must be context-efficient (SKILL.md under 7k tokens, selective reference loading)
MANDATORY: References map to phase types for intelligent loading
MANDATORY: Core principles in SKILL.md enable planning without loading all references
No exceptions. Context efficiency is the primary purpose of domain expertise.
</critical_constraint>
```
