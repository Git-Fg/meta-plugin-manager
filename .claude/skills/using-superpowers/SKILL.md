...
description: "Establish skill discipline. Use when: Starting a session to enforce systematic skill usage and prevent rationalization. Not for: Specific task execution (use relevant skills)."
---
...
- `skill-development` - For creating skills
- `command-development` - For creating commands
...
4. **Use subagent-driven-development** - Execute with two-stage review
