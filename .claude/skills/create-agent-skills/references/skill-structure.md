...
- ## 
## Success Criteria or **`<when_successful>`** - How to know it worked
...
Be consistent within your skill. If you use `
## Workflow

`, don't also use `
## Process

` for the same purpose (unless they serve different roles).
