...
<input>User clicked signup button

## Output

track('signup_initiated', { source: 'homepage' })

#### Example 2

<input>Purchase completed
...
- **Validation required?** → Add `
## Validation

`
- **Pattern demonstration?** → Add `
## Examples
