...
Read these URLs when accuracy matters for subagent decision-making:
...
**Trust your judgment**: You know when validation is needed for accurate subagent decisions.
