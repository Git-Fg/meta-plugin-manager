...
Write descriptions that users can find naturally.

**Pattern:** "[Action] [object]. Use when [context] or user says '[phrases]'."

**Examples:**

| Description                                                                                      | Why It Works           |
| ------------------------------------------------------------------------------------------------ | ---------------------- |
| "Review code for security issues. Use when auditing code or when user mentions security review." | Includes user phrases  |
| "Deploy application to environment. Use for production deployments with validation gates."       | Clear context          |
| "Generate API documentation. Use when documenting endpoints or when user says 'document API'."   | User language included |

**Best practices:**

- Include user phrases they would actually say
- Differentiate from similar commands
- Keep under 60 characters for `/help` display
