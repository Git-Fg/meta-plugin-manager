...
### Anti-Pattern 6: Forked Skill Without Philosophy Bundle

**Problem**: Skill uses `context: fork` but lacks essential behavioral rules, causing quality degradation in isolation

**Evidence**: Forked skills lose access to `.claude/rules/`. Without bundled philosophy, they may:

- Modify files when they should be read-only
- Apply wrong standards (style vs security)
- Break portability invariants
- Generate false positives/negatives

**Recognition**: "Does this skill use `context: fork`? If yes, does it include critical behavioral rules?"

**Bad** (relies on external rules):
...
[Result: When forked, may modify code or generate false positives]
```

**Fix** (includes philosophy bundle):
...
**Critical**: See `advanced-execution.md` - "Philosophy Bundles" section for complete implementation guidance.

---

## Description Anti-Patterns

### Anti-Pattern 7: "Use to" Language
...
### Anti-Pattern 9: Missing Triggers
...
### Anti-Pattern 10: Over-Specified Description
...
### Anti-Pattern 12: Unnecessary Tier 3
...
### Anti-Pattern 13: Nested References
...
### Anti-Pattern 14: Low Knowledge Delta
...
### Anti-Pattern 16: Over-Prescriptive Workflows
...
### Anti-Pattern 17: Missing Completion Markers
...
### Anti-Pattern 18: No Error Handling
...
### Anti-Pattern 19: Extraneous Documentation Files
...
### Anti-Pattern 21: Brittle Script Paths
...
### Anti-Pattern 22: Missing Script Validation
...
### Anti-Pattern 23: Assuming Context Inheritance in Forked Skills
...
### Anti-Pattern 24: Assuming Nested Forking Doesn't Work
...
### Anti-Pattern 25: Assuming System-Level Error Detection in Forked Skills
