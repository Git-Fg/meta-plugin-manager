---
description: "Create complete invocable packages (rooter archetype) with command, workflows, skill, references, examples, and scripts. Use when building comprehensive capability packages with multiple entry points."
argument-hint: [rooter name and description]
---
...
<success_criteria>Full rooter structure created with command, skill, workflows, references, and optional examples/scripts</success_criteria>
</mission_control>
...
- **Command**: Quick intent invocation (`/my-rooter`)
...
2. **What structure is needed?**
   ...
   - Full rooter with workflows/examples? (complex)
...
Create rooter directory structure:
...
```
/toolkit:rooter Create a Docker deployment package
...
```
/toolkit:rooter Create API rate limiting
...
```
/toolkit:rooter Create incident response workflow
...
No exceptions. Rooter is a package, not a monolith.
</critical_constraint>
