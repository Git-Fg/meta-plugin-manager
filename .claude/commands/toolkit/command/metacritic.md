...
# Meta-Critic Review for Commands
...
2. **User providing feedback?**
   ...
   - "Something's off"
   - Trigger meta-critic to diagnose
...
```
/toolkit:command:metacritic commands/build/fix.md
```

**Context analysis:**

```
/toolkit:command:metacritic auto
...
AI: [Suggests] /toolkit:command:metacritic
```
...
No exceptions. Meta-critic validates alignment between request, delivery, and standards.
</critical_constraint>
