...
Use when you need to create something but aren't sure which component type best fits your needs:
- "I want to build a new capability but don't know if it should be a skill, command, or something else"
- "I have an idea but need guidance on the right approach"
- "I want to automate a workflow but don't know which component type to choose"
