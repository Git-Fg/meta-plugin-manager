---
name: security-scan
description: "Execute predefined security scans and display results when user mentions 'security-scan', 'scan-security', or 'quick security check'. Integrates with security-auditor for comprehensive analysis. Not for deep security reviews."
user-invocable: true
disable-model-invocation: true
---

<mission_control>
<objective>Execute predefined security scans for rapid vulnerability assessment</objective>
<success_criteria>Scan complete with findings categorized by severity and actionable recommendations</success_criteria>
</mission_control>
...
<critical_constraint>
MANDATORY: Never modify code during security scan - only analyze and report
MANDATORY: Categorize findings by severity (Critical/High/Medium/Low)
MANDATORY: Provide file:line references for all findings
MANDATORY: Include clear remediation guidance with each finding
No exceptions. Security scans are read-only assessments.
</critical_constraint>
