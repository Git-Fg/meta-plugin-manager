---
name: update-docs
description: Sync documentation from source-of-truth. Use when: code changes, new features added, or documentation drift detected. Keeps docs aligned with codebase.
